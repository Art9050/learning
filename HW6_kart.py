...
# --В ответе приложите два файла - скрипт python (.py) и результат работы (xlsx).

# --Легкий режим:
# --1. Вы забираете данные с листа 'easy' в medicine.xlsx. 
# --2. Нужно отыскать пациентов, у которых не в норме хотя бы один анализ. 
# --3. Вывести телефон, имя, название анализа и заключение 'Повышен' или 'Понижен'. 
# --4. Сохранить в xlsx.

# --Сложный режим:
# --1. Вы забираете данные с листа 'hard' в medicine.xlsx. 
# --2. Нужно отыскать пациентов, у которых не в норме два и более анализов. 
# --3. Вывести телефон, имя, название анализа и заключение 'Повышен', 'Понижен' или 'Положительный'. 
# --4. Сохранить в xlsx.

# --5. Сохраните таблицу с расшифрованными значениями и результатами анализа в таблице de11an.xxxx_med_results в базе данных.
